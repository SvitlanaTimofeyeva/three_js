  ...
  WebGLParameters getParameters(
    ...
    final parameters = WebGLParameters(
      ...
      outputColorSpace: (currentRenderTarget == null)
          ...
          : (currentRenderTarget.isXRRenderTarget
      ...
      displacementMap:
          capabilities.vertexTextures && material.displacementMap != null,
      ...
      aoMapUv: material.aoMap == null
          ? null
          : getChannel(material.aoMap!.channel),
      lightMapUv: material.lightMap == null
          ? null
          : getChannel(material.lightMap!.channel),
      bumpMapUv: material.bumpMap == null
          ? null
          : getChannel(material.bumpMap!.channel),
      normalMapUv: material.normalMap == null
          ? null
          : getChannel(material.normalMap!.channel),
      displacementMapUv: material.displacementMap == null
          ? null
          : getChannel(material.displacementMap!.channel),
      emissiveMapUv: material.emissiveMap == null
          ? null
          : getChannel(material.emissiveMap!.channel),

      metalnessMapUv: material.metalnessMap == null
          ? null
          : getChannel(material.metalnessMap!.channel),
      roughnessMapUv: material.roughnessMap == null
          ? null
          : getChannel(material.roughnessMap!.channel),

      anisotropyMapUv: material.anisotropyMap == null
          ? null
          : getChannel(material.anisotropyMap!.channel),

      clearcoatMapUv: material.clearcoatMap == null
          ? null
          : getChannel(material.clearcoatMap!.channel),
      clearcoatNormalMapUv: material.clearcoatNormalMap == null
          ? null
          : getChannel(material.clearcoatNormalMap!.channel),
      clearcoatRoughnessMapUv: material.clearcoatRoughnessMap == null
          ? null
          : getChannel(material.clearcoatRoughnessMap!.channel),

      iridescenceMapUv: material.iridescenceMap == null
          ? null
          : getChannel(material.iridescenceMap!.channel),
      iridescenceThicknessMapUv: material.iridescenceThicknessMap == null
          ? null
          : getChannel(material.iridescenceThicknessMap!.channel),

      sheenColorMapUv: material.sheenColorMap == null
          ? null
          : getChannel(material.sheenColorMap!.channel),
      sheenRoughnessMapUv: material.sheenRoughnessMap == null
          ? null
          : getChannel(material.sheenRoughnessMap!.channel),

      specularMapUv: material.specularMap == null
          ? null
          : getChannel(material.specularMap!.channel),
      specularColorMapUv: material.specularColorMap == null
          ? null
          : getChannel(material.specularColorMap!.channel),
      specularIntensityMapUv: material.specularIntensityMap == null
          ? null
          : getChannel(material.specularIntensityMap!.channel),

      transmissionMapUv: material.transmissionMap == null
          ? null
          : getChannel(material.transmissionMap!.channel),
      thicknessMapUv: material.thicknessMap == null
          ? null
          : getChannel(material.thicknessMap!.channel),

      alphaMapUv: material.alphaMap == null
          ? null
      ...
      pointsUvs:
          ...
          (material.map != null || material.alphaMap != null),
      ...
      decodeVideoTexture:
          ...
          (ColorManagement.getTransfer(
                ColorSpace.fromString(material.map!.colorSpace),
              ) ==
              SRGBTransfer),
